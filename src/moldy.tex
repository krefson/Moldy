...
%%%%%%% RCS Emulation stuff                                 %%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newcommand{\RCSrevision}{$ $Revision: 2.29.4.5 $ $}
...
\item[-b] bond limits in tenths of {\AA}ngstroms entered in form
...
\item[-b] bond interval limits in tenths of {\AA}ngstroms entered in form
...
monatomic or polyatomic. This option is overridden by options \Lit{-f}, \Lit{-t} and \Lit{-p}.
