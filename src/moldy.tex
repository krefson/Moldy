...
%%%%%%% RCS Emulation stuff                                 %%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newcommand{\RCSrevision}{$ $Revision: 2.17 $ $}
...
\item[Windows 95/NT] The most straightforward way to build \moldy\ is
  ...
  \Lit{\htmladdnormallink{http://www.fu.is.saga-u.ac.jp/\%7Ecolin/gcc.html}%
{http://www.fu.is.saga-u.ac.jp/\%7Ecolin/gcc.html}} which contains links
  to both distributions. (The mirror site in the USA
  \Lit{\htmladdnormallink{http://www.geocities.com/Tokyo/Towers/6162/gcc.html}%
