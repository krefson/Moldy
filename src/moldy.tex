...
%%%%%%% RCS Emulation stuff                                 %%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newcommand{\RCSrevision}{$ $Revision: 2.25.2.3 $ $}
\newcommand{\moldyversion}{2.14}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
kcal mol$^{-1}$, specify \Lit{time-unit=4.8888213e-14}.
...
to msd, the time intervals selected using \Lit{-m} are taken relative 
...
\emph{gnuplot} and \emph{xmgrace}.  It can also write a command script
...
\begin{Argdescription}  
      ...
      \item[-g]         Write a GNUPLOT script to plot data
      \item[-gg]        Write a script and invoke GNUPLOT to plot data
      \item[-ps]        Invoke GNUPLOT to plot data and write as a PostScript file
      \item[-eps]       Invoke GNUPLOT to plot data and write as an
        encapsulated  PostScript (EPS) file
      \item[-xg]        Write a GRACE script to plot data
      \item[-xgg]       Write a script and invoke XMGRACE to plot data
      \item[-m]  output/plot only columns which match the (perl) regular expression REGEXP. (no '//' needed)    
\end{Argdescription}
