...
%%%%%%% RCS Emulation stuff                                 %%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newcommand{\RCSrevision}{$ $Revision: 2.12 $ $}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
example, if dump records 1,3,5..19 are extracted using \Lit{-t}, then
time intervals of \Lit{-m} 1-5 correspond to "real" intervals of
2,4,...,10 relative to the original dump file data. It should also be
...
trajectory data and are useful for reducingthe number of particle
