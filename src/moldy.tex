...
Tildesley\cite[page 88]{allen:87} we follow the definition of
...
includes potential of the {\em Born-Mayer\/} and {\em Buckingham\/} forms.
...
Though it is not apparent in reference\cite[Appendix A]{nose:83} this
...
\end{description}
Other types of potential may be easily added: see
...
\item[{\tt*E*}] error. Error messages are issued when a mistake is
...
scaling is linear, but the reciprocal-space sum uses temporary arrays
...
should be compiled with the preprocessor macro \texttt{PARALLEL}
...
inclusive and 34,44,54\ldots94.  Selectors are separated by commas and
