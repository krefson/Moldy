...
This is the format favoured by GNUPlot. Option \Lit{-w}  selects
...
species is replacing another polyatomic species, by default the same quaternions (orientation) will be used;
 otherwise quaternions are generated randomly for the new species. The \Lit{-k} option generates
...
matched with pre-existing components in the original structure or from the species data file when available. The \Lit{-x} option
